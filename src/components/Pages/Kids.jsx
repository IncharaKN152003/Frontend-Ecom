...
function Kids() {
  ...
  const hardcodedProducts = [
    ...
    { id: 6, name: "Casual Shirt & Jeans", category: "boys", subCategory: "boys", ageGroup: "Kids (5-8Y)", price: 1599, originalPrice: 2499, rating: 4.7, reviews: 112, image: "/assets/images/p.jpg", badge: "New Arrival", colors: ["#87CEEB","#98FB98","#FFA07A"], sizes: ["5T","6","7","8"] },
    { id: 7, name: "Traditional Kurta Set", category: "boys", subCategory: "traditional", ageGroup: "Preteen (8-12Y)", price: 2799, originalPrice: 3999, rating: 4.8, reviews: 78, image: "/assets/images/p11.jpg", badge: "Premium", colors: ["#800020","#FFD700","#2F4F4F"], sizes: ["8","10","12"] },
    { id: 8, name: "Party Blazer Set", category: "boys", subCategory: "party", ageGroup: "Teen (12-14Y)", price: 4499, originalPrice: 6499, rating: 4.9, reviews: 45, image: "/assets/images/p12.jpg", badge: "Exclusive", colors: ["#000000","#191970","#4A4A4A"], sizes: ["12","14"] },
    { id: 9, name: "Baby Romper Set", category: "babies", subCategory: "babies", ageGroup: "Infant (0-12M)", price: 999, originalPrice: 1499, rating: 4.8, reviews: 234, image: "/assets/images/u.jpg", badge: "Best Seller", colors: ["#FFB6C1","#87CEEB","#98FB98"], sizes: ["0-3M","3-6M","6-12M"] },
    ...
    { id: 15, name: "Graphic T-Shirt & Shorts", category: "boys", subCategory: "casual", ageGroup: "Kids (5-8Y)", price: 1199, originalPrice: 1799, rating: 4.6, reviews: 178, image: "/assets/images/d.jpg", badge: "New Arrival", colors: ["#87CEEB","#98FB98","#FFA07A"], sizes: ["5T","6","7","8"] },
    { id: 16, name: "Printed Leggings Set", category: "girls", subCategory: "casual", ageGroup: "Preteen (8-12Y)", price: 1399, originalPrice: 1999, rating: 4.7, reviews: 134, image: "/assets/images/t6.jpg", badge: "Trending", colors: ["#FFB6C1","#E6E6FA","#DDA0DD"], sizes: ["8","10","12"] },
    ...
    { id: 18, name: "Kids Kurta Pajama", category: "boys", subCategory: "traditional", ageGroup: "Kids (5-8Y)", price: 2199, originalPrice: 3299, rating: 4.7, reviews: 76, image: "/assets/images/f.jpg", badge: "Premium", colors: ["#8B4513","#FFD700","#2F4F4F"], sizes: ["5T","6","7","8"] }
  ];
